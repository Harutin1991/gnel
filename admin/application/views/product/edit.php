                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="upload_image_wrapper">
                                    ...
                                    <input name="Product[percent_off]" value="<?php echo set_value('Product[percent_off]', $product['percent_off']); ?>" type="text" class="form-control" id="percent_off">
                                    ...
                                    <input name="Product[amount_off]" value="<?php echo set_value('Product[amount_off]', $product['amount_off']); ?>" type="text" class="form-control" id="amount_off">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <input name="Product[youtube_link]" value="<?php echo set_value('Product[youtube_link]', $product['youtube_link']); ?>" type="text" class="form-control" id="youtube_link">
                                    ...
                                    <div class="tab-content">
                                        <?php foreach ($languages as $language) { ?>
                                            ...
                                            <div class="tab-pane <?php echo $is_default ? "active" : ""; ?>" id="<?php echo $language->code; ?>">
                                                ...
                                                <!--<input value="<?php echo set_value('Product[meta_description_' . $language->code . ']', $product['meta_description_' . $language->code]); ?>" type="text" class="form-control" id="meta_description">-->
                                                <textarea  name="Product[meta_description_<?php echo $language->code; ?>]" class="form-control" id="meta_description" rows="3"><?php echo set_value('Product[meta_description_' . $language->code . ']', $product['meta_description_' . $language->code]); ?></textarea>
