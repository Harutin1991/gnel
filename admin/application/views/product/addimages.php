<div class="row">
    <div>
        ...
        <a href="<?php echo base_url('product/options/' . $product['id']); ?>">Տարբերակներ >></a>
        <div>
                                ...
                                <tbody>
                                                    ...
                                                    <ul id="images">
                                                        <?php foreach ($product['images'] as $image): ?>
                                                            <li id="<?php echo $image->id; ?>">
                                                                <img src="<?php echo $this->config->item('frontend_url') . 'images/product/' . $product['id'] . '/' . $image->image; ?>" class="img-product img-thumbnail" id="img<?php echo $image->id; ?>" />
                                    ...
                                    <tr>
                                        <td >
                                            ...
                                            <a id="next_opt" href="<?php echo site_url('product/options') . '/' . $product['id']; ?>" class="btn btn-primary"><?php echo $this->lang->line('Next'); ?></a>
                                        </td>
                                    </tr>
                                </tbody>
    ...
    $(document).ready(function() {
        $('#upload-form').ajaxForm({
            ...
            success: function(data) {
                ...
                console.log(data);
                for (var key in data) {
                    img = '<img id="img' + data[key]['id'] + '" class="img-product img-thumbnail" src="<?php echo $this->config->item('frontend_url'); ?>' + 'images/product/' + data[key]['product_id'] + '/' + data[key]['image'] + '" />'
