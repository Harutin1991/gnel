                        ...
                        <tbody>
                            <tr>
                                <td>
                                    ...
                                    <input name="Partner[link]" value="<?php echo set_value('link'); ?>" type="text" class="form-control" id="link"/>
                                    ...
                                    <div class="tab-content">
                                        <?php foreach ($languages as $language) { ?>
                                            ...
                                            <div class="tab-pane <?php echo $is_default ? "active" : ""; ?>" id="<?php echo $language->code; ?>">
                                                ...
                                                <input name="Partner[name_<?php echo $language->code; ?>]" value="<?php echo set_value('Partner[name_' . $language->code . ']'); ?>" type="text" class="form-control" id="name" <?php echo $is_default ? "required='required'" : ""; ?>>
                                                ...
                                                <input name="Partner[meta_keywords_<?php echo $language->code; ?>]" value="<?php echo set_value('Partner[meta_keywords_' . $language->code . ']'); ?>" type="text" class="form-control" id="meta_keywords">
                                                ...
                                                <input name="Partner[meta_description_<?php echo $language->code; ?>]" value="<?php echo set_value('Partner[meta_description_' . $language->code . ']'); ?>" type="text" class="form-control" id="meta_description">
                                                ...
                                                <?php editor("Partner[description_" . $language->code . "]", 'band_description_' . $language->code, set_value('Partner[description_' . $language->code . ']')); ?>
                            ...
                            <tr>
                                <td>
                                    <label class="control-label" for="Partner[status]" ><?php echo $this->lang->line('Status'); ?></label>
                            <?php echo form_dropdown('Partner[status]', $statuses, set_value('Partner[status]'), 'id="page_status", class="form-control"'); ?>
                                    <div class="error"><?php echo form_error('Partner[status]'); ?></div>
                                </td>
                            </tr>
                            -->
                            <tr><td></td></tr>
