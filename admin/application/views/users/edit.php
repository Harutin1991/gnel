                    ...
                    <tbody>
                        <tr>
                            <td>
                                ...
                                <input name="login" value="<?php echo $edit_user['username']; ?>" class="form-control" id="login" type="text">
                            ...
                            <td>
                                <fieldset>
                                    ...
                                    <?php foreach ($roles as $index => $element) { ?>                                           
                                        <nobr><input name="roles" value="<?php echo $element['rol_id']; ?>" id="roles[<?php echo $index; ?>]" type="radio" <?php if ($element['rol_id'] == $edit_user['rol_id']) echo 'checked'; ?> >
