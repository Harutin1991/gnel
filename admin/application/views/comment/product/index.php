    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="pending_comment_checkbox_wrapper">
                <input type="checkbox" name="pending" value="1" <?php echo $pr_pending == 1 ? 'checked="checked"' : ''; ?> />
            ...
            <div id="data_table">
                <?php $this->load->view('comment/product/datatable.php'); ?>
            </div>  
...
<script>
    $(document).ready(function() {
        ...
        $('input[name=pending]').change(function(){
            ...
            $.cookie('pr_pending', pending, {expires: 1, path: '/'});
            ajax_filter(1);
        ...
        function ajax_filter(pr_pagenum) {
            ...
            var pr_pending = $('input[name=pending]').is(':checked') ? 1 : 0;
            $('.ajax_loader').show();
            $.ajax({
                url: base_url + "ajax",
                dataType: 'json',
