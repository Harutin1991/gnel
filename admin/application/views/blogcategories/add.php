                                    ...
                                    <div class="tab-content">
                                        <?php foreach ($languages as $language) { ?>
                                            ...
                                            <div class="tab-pane <?php echo $is_default ? "active" : ""; ?>" id="<?php echo $language->code; ?>">
                                                ...
                                                <input name="Blogcategories[title_<?php echo $language->code; ?>]" value="<?php echo set_value('Blogcategories[title_' . $language->code . ']'); ?>" type="text" class="form-control" id="Blogcategories[title_<?php echo $language->code; ?>]" <?php echo $is_default ? "required='required'" : ""; ?>>
                                                ...
                                                <?php editor("Blogcategories[content_" . $language->code . "]", 'content_' . $language->code, set_value('Blogcategories[content_' . $language->code . ']')); ?>
                                                ...
                                                <input name="Blogcategories[meta_keywords_<?php echo $language->code; ?>]" value="<?php echo set_value('Blogcategories[meta_keywords_' . $language->code . ']'); ?>" type="text" class="form-control" id="Blogcategories[meta_keywords_<?php echo $language->code; ?>]">
                                                ...
                                                <input name="Blogcategories[meta_description_<?php echo $language->code; ?>]" value="<?php echo set_value('Blogcategories[meta_description_' . $language->code . ']'); ?>" type="text" class="form-control" id="Blogcategories[meta_description_<?php echo $language->code; ?>]">
