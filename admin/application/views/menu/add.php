...
<div style="display: none">
    <button  class="btn btn-primary noty" data-noty-options="{&quot;text&quot;:&quot;<?php echo $this->lang->line('Menu has added successfully'); ?>&quot;,&quot;layout&quot;:&quot;topCenter&quot;,&quot;type&quot;:&quot;success&quot;}">
                        ...
                        <form method="POST" >
                            <tr>
                                <td>
                                    ...
                                    <input name="Menu[name]" value="<?php echo set_value('Menu[name]'); ?>" type="text" class="form-control" id="name">
