                    ...
                    <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="tab-content">
                                    <?php foreach ($languages as $language) { ?>
                                        ...
                                        <div class="tab-pane <?php echo $is_default ? 'active' : ''; ?>" id="<?php echo $language->code; ?>">
                                            ...
                                            <input name="Contact_topic[title_<?php echo $language->code; ?>]" value="<?php echo set_value('Contact_topic[title_' . $language->code . ']', $contact_topic['title_' . $language->code]); ?>" type="text" class="form-control" id="title" <?php echo $is_default ? 'required="required"' : ''; ?>>
                                            ...
                                            <input name="Contact_topic[short_content_<?php echo $language->code; ?>]" value="<?php echo set_value('Contact_topic[short_content_' . $language->code . ']', $contact_topic['short_content_' . $language->code]); ?>" type="text" class="form-control" id="title">
                                            ...
                                            <?php editor("Contact_topic[content_" . $language->code . "]", 'Contact_topic[content_' . $language->code, set_value('Contact_topic[content_' . $language->code . ']', $contact_topic['content_' . $language->code])); ?>
                        ...
                        <tr>
                            <td class="upload_image_wrapper">
                                <?php $img_url = $contact_topic['image'] != '' ? $this->config->item('frontend_url') . 'images/contact/' . $contact_topic['image'] : base_url('img/upload-icon.png'); ?>
