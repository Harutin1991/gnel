                                ...
                                <div class="tab-content">
                                    <?php foreach ($languages as $language) { ?>
                                        ...
                                        <div class="tab-pane <?php echo $is_default ? 'active' : ''; ?>" id="<?php echo $language->code; ?>">
                                            ...
                                            <input name="Faq[question_<?php echo $language->code; ?>]" value="<?php echo set_value('Faq[question_' . $language->code . ']'); ?>" type="text" class="form-control" id="question" <?php echo $is_default ? 'required="required"' : ''; ?>>
                                            ...
                                            <?php editor("Faq[answer_" . $language->code . "]", 'Faq[answer_' . $language->code, set_value('Faq[answer_' . $language->code . ']')); ?>
