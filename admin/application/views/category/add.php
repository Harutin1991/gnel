                        ...
                        <tbody>
                                        ...
                                        <?php foreach ($languages as $language): ?>
                                            <?php if ($language->code == $default_language): ?>
                                                <div class="tab-pane active" id="<?php echo $language->code; ?>">
                                                    <br />
                                                    <label class="control-label required" for="Category[name_<?php echo $language->code; ?>]"><?php echo $this->lang->line('Name'); ?></label>
                                                    <input name="Category[name_<?php echo $default_language; ?>]" value="<?php echo set_value('Category[name_'.$language->code.']'); ?>" type="text" class="form-control" id="name">
                                                    ...
                                                    <input name="Category[meta_keywords_<?php echo $language->code; ?>]" value="<?php echo set_value('Category[meta_keywords_'.$language->code.']'); ?>" type="text" class="form-control" id="meta_keywords">
                                                    ...
                                                    <input name="Category[meta_description_<?php echo $language->code; ?>]" value="<?php echo set_value('Category[meta_description_'.$language->code.']'); ?>" type="text" class="form-control" id="meta_description">
                                                    ...
                                                    <?php editor("Category[description_".$language->code."]", 'category_text_'.$language->code, set_value('Category[description_'.$language->code.']')); ?>
                                            ...
                                            <?php else: ?>
                                                <div class="tab-pane" id="<?php echo $language->code; ?>">
                                                    <br />
                                                    <label class="control-label" for="Category[name_<?php echo $language->code; ?>]"><?php echo $this->lang->line('Name'); ?></label>
                                                    <input name="Category[name_<?php echo $language->code; ?>]" value="<?php echo set_value('Category[name_'.$language->code.']'); ?>" type="text" class="form-control" id="name">
                                                    <div class="error"><?php echo form_error('Category[name_'.$language->code.']'); ?></div>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div id="img-div" style="display:none">
                                        <img id="current-image" src="<?php echo base_url('img/upload-icon.png'); ?>" width="100" title="<?php echo $this->lang->line('Add image'); ?>" />
                                    </div>
                                </td>
                            </tr>
                            <!--
                            <tr>
                                <td>
                                    ...
                                    <?php 
                                    //echo form_dropdown('Category[status]', $statuses, set_value('Category[status]'), 'id="category_status", class="form-control"'); ?>
