<?php if ($this->session->flashdata('message') == 'add_success'): ?>
    <div style="display: none">
        <button  class="btn btn-primary noty" data-noty-options="{&quot;text&quot;:&quot;<?php echo $this->lang->line('Language has added successfully'); ?>&quot;,&quot;layout&quot;:&quot;topCenter&quot;,&quot;type&quot;:&quot;success&quot;}">
                ...
                <table class="span5">
                    <form method="POST" >
                        <tbody>
                            <tr>
                                <td>
                                    <label class="control-label required" for="Languages[code]" ><?php echo $this->lang->line('Code'); ?></label>
                                    <input name="Languages[code]" value="<?php echo set_value('Languages[code]'); ?>" type="text" class="form-control" id="name">
                                        ...
                                        <?php foreach ($languages as $language): ?>
                                            <?php if ($language->code == $default_language): ?>
                                                <div class="tab-pane active" id="<?php echo $language->code; ?>">
                                                    ...
                                                    <input name="Languages[name_<?php echo $default_language; ?>]" value="<?php echo set_value('Languages[name_' . $language->code . ']'); ?>" type="text" class="form-control" id="name">
                                            ...
                                            <?php else: ?>
                                                <div class="tab-pane" id="<?php echo $language->code; ?>">
                                                    ...
                                                    <input name="Languages[name_<?php echo $language->code; ?>]" value="<?php echo set_value('Languages[name_' . $language->code . ']'); ?>" type="text" class="form-control" id="name">
                                                    <div class="error"><?php echo form_error('Languages[name_' . $language->code . ']'); ?></div>
                                                </div>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
