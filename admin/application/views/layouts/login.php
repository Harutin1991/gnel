...
<head>
    ...
    <!-- The styles -->
    <link id="bs-css-" href="<?php echo site_url('layout_data/css/bootstrap-cerulean.min.css'); ?>" rel="stylesheet">
...
<script src='<?php echo site_url('bower_components/fullcalendar/dist/fullcalendar.min.js'); ?>'></script>
<!-- data table plugin -->
