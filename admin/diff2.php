<div class="tab-pane active" id="<?php echo $language->code; ?>">
    <br />
    <label class="control-label required" for="Page[title_<?php echo $language->code; ?>]"><?php echo $this->lang->line('Title'); ?></label>
    <input name="Page[title_<?php echo $default_language; ?>]" value="<?php echo set_value('Page[title_' . $language->code . ']'); ?>" type="text" class="form-control" id="title">
