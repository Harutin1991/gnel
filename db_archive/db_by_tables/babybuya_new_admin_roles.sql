...
CREATE TABLE `admin_roles` (
  ...
  `rol_name` varchar(64) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`rol_id`)
...
INSERT INTO `admin_roles` VALUES (1,'Super Admin'),(2,'Admin'),(3,'operator');
...
-- Dump completed on 2015-10-23 12:02:05
